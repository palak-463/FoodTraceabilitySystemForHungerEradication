...
public class MyNgo extends FirebaseRecyclerAdapter<RestaurantInfo,MyNgo.myViewHolder>{



    public MyNgo(@NonNull FirebaseRecyclerOptions<RestaurantInfo> options) {
        super(options);
    }
