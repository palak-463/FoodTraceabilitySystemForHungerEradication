...
public class FarmerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Forgot.setOnTouchListener(new CustomTouchListener());
        Forgot.setPaintFlags(Forgot.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);

        Forgot.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(FarmerLogin.this, ForgotPassword.class).putExtra("from", "activity1");
                startActivity(intent);
            }

        });

        Signup.setOnTouchListener(new CustomTouchListener());
        Signup.setPaintFlags(Signup.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);

        Signup.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(FarmerLogin.this, FarmerSignup.class);
                startActivity(intent);
            }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (user.isEmailVerified()) {
                                Intent intent = new Intent(FarmerLogin.this, FarmerWelcome.class);
                                startActivity(intent);
                            } else {
                                user.sendEmailVerification();
                                Toast.makeText(FarmerLogin.this, "Check your email to verify your account!", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(FarmerLogin.this, "Failed to login!,Please check your credentials!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
        ...
        i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(FarmerLogin.this, MainActivity.class);
                startActivity(i);
            }
        });
    }
