    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(RestaurantLogin.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        Forgot.setOnTouchListener(new RestaurantLogin.CustomTouchListener());
        Forgot.setPaintFlags(Forgot.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);

        Forgot.setOnClickListener(new View.OnClickListener(){
            public void onClick (View view) {
                Intent intent = new Intent(RestaurantLogin.this, ForgotPassword.class).putExtra("from","activity2");
                startActivity(intent);
            }

        });

        Signup.setOnTouchListener(new RestaurantLogin.CustomTouchListener());
        Signup.setPaintFlags(Signup.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);

        Signup.setOnClickListener(new View.OnClickListener(){
            public void onClick (View view) {
                Intent intent = new Intent(RestaurantLogin.this, RestaurantSignup.class);
                startActivity(intent);
            }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(user.isEmailVerified()) {
                                Intent intent = new Intent(RestaurantLogin.this, RestaurantMain.class);
                                startActivity(intent);
                            }
                            else
                            {
                                user.sendEmailVerification();
                                Toast.makeText(RestaurantLogin.this, "Check your email to verify your account!", Toast.LENGTH_LONG).show();
                            }
                        }
                        else
                        {
                            Toast.makeText(RestaurantLogin.this, "Failed to login!,Please check your credentials!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
